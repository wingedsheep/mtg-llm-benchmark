...
from engine.core.actions_system import Action, action_generator, action_validator
from engine.core.core_types import Phase, GameEvent
from engine.core.display_system import game_formatter, game_logger
from engine.core.effects_system import TriggerManager
from engine.core.player_system import Player, PlayerManager
...
class GameState:
    ...
    def _enter_phase(self):
        ...
        if self.phase == Phase.UNTAP:
            ...
            from engine.core.combat_system import combat_system
