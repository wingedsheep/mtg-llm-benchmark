...
from gameplay.engine.core_types import Zone
from gameplay.engine.deck_system import DeckSystem
from gameplay.engine.display_system import game_logger
from gameplay.engine.scry_system import ScrySystem, ScryChoice
...
def create_mulligan_system() -> MulliganSystem:
    ...
    from gameplay.engine.scry_system import scry_system
...
def create_simple_scry_callback() -> Callable[['Player', List['Card']], ScryChoice]:
    ...
    def callback(player: 'Player', scry_cards: List['Card']) -> ScryChoice:
        # This is just for testing - real agents would make more sophisticated decisions
        from gameplay.engine.scry_system import create_default_scry_choice
